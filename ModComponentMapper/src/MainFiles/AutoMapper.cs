...
namespace ModComponentMapper
{
    public class AutoMapper
    {
        ...
        public static string GetAutoMapperDirectory() => Path.Combine(Implementation.GetModsFolderPath(), AUTO_MAPPER_DIRECTORY_NAME);
        ...
        private static void AutoMapPrefab(string prefabName)
        {
            ...
            if (obj == null)
            {
                Logger.LogWarning("In AutoMapPrefab, Resources.Load returned null.");
            }
