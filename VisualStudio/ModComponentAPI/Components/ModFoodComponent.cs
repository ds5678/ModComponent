...
namespace ModComponentAPI
{
    public class ModFoodComponent : ModCookableComponent
    {
        ...
        /// <summary>
        /// The number of servings contained in this item.<br/>
        /// Each consumation will be limited to one serving.<br/>
        /// 1 means 'Comsume completely' - the way all pre-existing food items work.
        /// </summary>
