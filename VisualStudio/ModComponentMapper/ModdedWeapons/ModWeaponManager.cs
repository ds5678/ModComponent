namespace ModComponentMapper
{
    ...
    internal static class GameManagerInstantiatePlayerObjectPatch
    {
    ...
    class FixMuzzleFlashTransformParent : MonoBehaviour //NEEDS TO BE DECLARED
    {
        ...
        static FixMuzzleFlashTransformParent() => UnhollowerRuntimeLib.ClassInjector.RegisterTypeInIl2Cpp<FixMuzzleFlashTransformParent>(false);
    }
#endif
}
