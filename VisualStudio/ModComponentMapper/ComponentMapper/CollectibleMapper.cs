...
namespace ModComponentMapper
{
	internal static class CollectibleMapper
	{
		internal static void Configure(ModComponent modComponent)
		{
			...
			NarrativeCollectibleItem narrativeCollectible = ComponentUtils.GetOrCreateComponent<NarrativeCollectibleItem>(modCollectible);
			...
			narrativeCollectible.m_TextAlignment = EnumUtils.TranslateEnumValue<NGUIText.Alignment, ModCollectibleComponent.Alignment>(modCollectible.TextAlignment);
