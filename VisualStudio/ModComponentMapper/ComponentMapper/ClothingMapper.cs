...
namespace ModComponentMapper.ComponentMapper
{
    internal static class ClothingMapper
    {
        internal static void ConfigureClothing(ModComponent modComponent)
        {
            ...
            ClothingItem clothingItem = ComponentUtils.GetOrCreateComponent<ClothingItem>(modClothingItem);
            ...
            clothingItem.m_Region = EnumUtils.TranslateEnumValue<ClothingRegion, Region>(modClothingItem.Region);
            clothingItem.m_MaxLayer = EnumUtils.TranslateEnumValue<ClothingLayer, Layer>(modClothingItem.MaxLayer);
            clothingItem.m_MinLayer = EnumUtils.TranslateEnumValue<ClothingLayer, Layer>(modClothingItem.MinLayer);
            clothingItem.m_FootwearType = EnumUtils.TranslateEnumValue<FootwearType, Footwear>(modClothingItem.Footwear);
            clothingItem.m_WornMovementSoundCategory = EnumUtils.TranslateEnumValue<ClothingMovementSound, MovementSound>(modClothingItem.MovementSound);
        ...
        private static void ConfigureWolfIntimidation(ModClothingComponent modClothingItem)
        {
            ...
            WolfIntimidationBuff wolfIntimidationBuff = ComponentUtils.GetOrCreateComponent<WolfIntimidationBuff>(modClothingItem);
